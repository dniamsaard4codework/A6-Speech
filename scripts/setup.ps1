...
# Curated deps (no faster-whisper / whisper-timestamped / PyAV / gradio): se_extractor is
# bypassed by a6_speech.voice_clone (chunk-and-average tone-color extraction).
